...
if(!empty($_SESSION["user"])){
	echo('<form name="loginform" action="login.php" method="POST">
		...
		<form name="editcourse" action="checkedit.php" method="POST">
		<table width="40%" align="center" border="5" bordercolor="orange">
			<tr><td>Course Name: </td>
				<td><input type="text" name="coursename" value="'.$coursename.'" required class="texta"></td></tr>
			...
			<tr><td>Course Tags: </td>
				<td><input type="text" name="coursetags" value="'.$coursetags.'" required placeholder="i.e. English German" class="texta"></td></tr>
...
Your site:
Contact:" required class="texta">'.$description.'</textarea></td></tr>
			<tr><td>Starting Price: </td>
				<td><input type="text" name="price" required pattern="\d*" title="Please enter only numbers" placeholder=" Use TRY" value="'.$price.'" class="texta"></td></tr>
			<tr><td align="center" colspan="2"><input type="submit" name="test" value="Edit" class="button2"></td></tr>
		</table>
		</form>
		');
