...
<form name="signup1" action="checklogin1.php" method="POST">
...
<tr>
 <td> Company Name: </td> 
<td><input type="text" name="name1" id="name1" pattern=".{4,30}" required title="4 to 30 characters" class="texta"></td>
</tr>
<tr><td> E-Mail: </td> 
<td><input type="text" name="email1" id="email1" pattern=".{8,30}" required title="8 to 30 characters" class="texta"></td>
</tr>
<tr><td> Password: </td>
<td><input type="password" name="pass1" id="pass1" pattern=".{8,30}" required title="8 to 30 characters" class="texta"></td>
</tr>
<tr>
<td></td>
<td align="center"> <input type="submit" name="signup1" value="SIGN UP" class="button2">
</td>
</tr>
</table>
</form>
